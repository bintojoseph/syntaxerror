...
describe('query', function () {
    var INDEX_NAME = 'ts-integration';
    var pinecone, index, ns, namespace;
    ...
    test('query by id', function () { return __awaiter(void 0, void 0, void 0, function () {
        var recordsToUpsert, topK, results;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    recordsToUpsert = (0, test_helpers_1.generateRecords)(5, 3);
                ...
                case 1:
                    _b.sent();
                    topK = 2;
                    return [4 /*yield*/, ns.query({ id: '0', topK: topK })];
                case 2:
                    results = _b.sent();
    ...
    test('query when topK is greater than number of records', function () { return __awaiter(void 0, void 0, void 0, function () {
        var numberOfRecords, recordsToUpsert, topK, results;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    numberOfRecords = 3;
                    recordsToUpsert = (0, test_helpers_1.generateRecords)(5, numberOfRecords);
                    expect(recordsToUpsert).toHaveLength(3);
                    expect(recordsToUpsert[0].id).toEqual('0');
                    expect(recordsToUpsert[1].id).toEqual('1');
                    expect(recordsToUpsert[2].id).toEqual('2');
                ...
                case 2:
                    results = _b.sent();
                    expect(results.matches).toBeDefined();
                    expect((_a = results.matches) === null || _a === void 0 ? void 0 : _a.length).toEqual(numberOfRecords);
                    return [2 /*return*/];
            }
        });
    }); });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    topK = 2;
                    return [4 /*yield*/, ns.query({ id: '100', topK: topK })];
                case 2:
                    results = _b.sent();
                    expect(results.matches).toBeDefined();
    ...
    test('query with vector values', function () { return __awaiter(void 0, void 0, void 0, function () {
        var numberOfRecords, recordsToUpsert, topK, results;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
