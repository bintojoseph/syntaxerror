...
describe('create index', function () {
    ...
    describe('happy path', function () {
        ...
        test('create with optional properties', function () { return __awaiter(void 0, void 0, void 0, function () {
            var description;
            var _a, _b, _c, _d, _e, _f, _g;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 2:
                        ...
                        expect((_a = description.database) === null || _a === void 0 ? void 0 : _a.name).toEqual(indexName);
                        expect((_b = description.database) === null || _b === void 0 ? void 0 : _b.dimension).toEqual(5);
                        expect((_c = description.database) === null || _c === void 0 ? void 0 : _c.metric).toEqual('euclidean');
                        expect((_d = description.database) === null || _d === void 0 ? void 0 : _d.pods).toEqual(2);
                        expect((_e = description.database) === null || _e === void 0 ? void 0 : _e.replicas).toEqual(2);
                        expect((_f = description.database) === null || _f === void 0 ? void 0 : _f.shards).toEqual(1);
                        expect((_g = description.status) === null || _g === void 0 ? void 0 : _g.host).toBeDefined();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        description = _c.sent();
                        expect((_a = description.database) === null || _a === void 0 ? void 0 : _a.name).toEqual(indexName);
                        expect((_b = description.status) === null || _b === void 0 ? void 0 : _b.state).toEqual('Ready');
                        return [2 /*return*/];
                }
            });
        }); });
