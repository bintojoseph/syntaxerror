...
describe('Pinecone', function () {
    describe('constructor', function () {
        describe('required properties', function () {
            test('should throw an error if no properties provided', function () {
                expect(function () {
                    new pinecone_1.Pinecone({});
                }).toThrow('The client configuration must have required properties: environment, apiKey.');
            });
            test('should throw an error if required property not provided', function () {
                expect(function () {
                    new pinecone_1.Pinecone({ apiKey: 'test-key' });
                }).toThrow('The client configuration must have required property: environment.');
                expect(function () {
                    new pinecone_1.Pinecone({
            ...
            test('should throw an error if required properties are blank', function () {
                expect(function () {
                    new pinecone_1.Pinecone({
                        environment: '',
                        projectId: '',
                ...
                }).toThrow("The client configuration had validation errors: property 'environment' must not be blank, property 'projectId' must not be blank.");
                expect(function () {
                    var config = {
        ...
        describe('optional properties', function () {
            test('should not throw when optional properties provided: fetchAPI', function () {
                expect(function () {
                    new pinecone_1.Pinecone({
                        environment: 'test-env',
                        apiKey: 'test-key',
    ...
    describe('typescript: generic types for index metadata', function () {
        test('passes generic types from index()', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        p = new pinecone_1.Pinecone({ apiKey: 'foo', environment: 'bar' });
