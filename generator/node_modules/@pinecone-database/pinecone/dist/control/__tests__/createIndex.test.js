...
describe('createIndex', function () {
    test('calls the openapi create index endpoint, passing name and dimension', function () { return __awaiter(void 0, void 0, void 0, function () {
        var IOA, returned;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    IOA = setupCreateIndexResponse(undefined, undefined);
                    return [4 /*yield*/, (0, createIndex_1.createIndex)(IOA)({
                            name: 'index-name',
                            dimension: 10,
                        })];
                case 1:
