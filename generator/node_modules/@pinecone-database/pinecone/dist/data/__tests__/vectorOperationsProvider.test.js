...
describe('VectorOperationsProvider', function () {
    var real;
    beforeAll(function () {
        real = projectIdSingleton_1.ProjectIdSingleton.getProjectId;
    });
    afterAll(function () {
        projectIdSingleton_1.ProjectIdSingleton.getProjectId = real;
    });
    beforeEach(function () {
        projectIdSingleton_1.ProjectIdSingleton.getProjectId = jest.fn();
    });
    afterEach(function () {
    ...
    test('makes no API calls on instantiation', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            expect(projectIdSingleton_1.ProjectIdSingleton.getProjectId).not.toHaveBeenCalled();
            return [2 /*return*/];
        });
    }); });
    test('api calls occur only the first time the provide method is called', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    api = _a.sent();
                    expect(projectIdSingleton_1.ProjectIdSingleton.getProjectId).toHaveBeenCalled();
                    return [4 /*yield*/, provider.provide()];
                case 2:
                    api2 = _a.sent();
                    expect(projectIdSingleton_1.ProjectIdSingleton.getProjectId).toHaveBeenCalledTimes(1);
