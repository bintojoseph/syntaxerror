import { ConfigureIndexOptions, CreateCollectionOptions, CreateIndexOptions, IndexName, CollectionName } from './control';
...
export declare class Pinecone {
     ...
     */
    describeIndex(indexName: IndexName): Promise<import("./pinecone-generated-ts-fetch").IndexMeta>;
    /**
     ...
     */
    listIndexes(): Promise<import("./control").IndexList>;
    /**
     * Creates a new index.
     *
     * @example
     ...
     */
    configureIndex(indexName: IndexName, options: ConfigureIndexOptions): Promise<void>;
    /**
     ...
     */
    listCollections(): Promise<import("./control").CollectionList>;
    /**
     ...
     */
    describeCollection(collectionName: CollectionName): Promise<import("./control").CollectionDescription>;
    /** @internal */
     ...
     */
    index<T extends RecordMetadata = RecordMetadata>(indexName: string): Index<T>;
    /**
     * {@inheritDoc index}
     */
    Index<T extends RecordMetadata = RecordMetadata>(indexName: string): Index<T>;
